...
*/
			String hql ="Select LD.landid, LD.landno, LC.claimtypeid, LC.claimtype_en, LD.area, la.applicationstatus_en,TR.transactionid, LP.firstname, LP.middlename, LP.lastname, LH.name_en ,ST.landsharetype " +
