...
//		List<CustomAttributes> lst = new ArrayList<>();
 ...
 /*   @RequestMapping(value = "/viewer/resource/PoiData/{landid}/{projectId}", method = RequestMethod.GET)
    @ResponseBody
    public List<Object[]> getAllResourcePoiData(@PathVariable Integer projectId, @PathVariable Integer landid) {
		
		List<Object[]> lst = new ArrayList<>();
		
		lst=resourceCustomAttributesdao.getResourcePoiDataBylandId(projectId, landid);
   ...
   public ResponseEntity saveResourcelPersonForEditing(HttpServletRequest request,@PathVariable Integer landid, HttpServletResponse response)
	{
		try 
		{
			...
			try{community_area=ServletRequestUtils.getRequiredStringParameter(request, "Community Area");}catch(Exception e){}
   ...
   public ResponseEntity saveResourcePoi(HttpServletRequest request,@PathVariable String geomName, @PathVariable Integer landid, HttpServletResponse response,Principal principal)
	{
		...
		try 
		{
			...
			String project =userobj.getDefaultproject();
			 ...
			 projectId= objproject.getProjectnameid();
		    try{landId = ServletRequestUtils.getRequiredIntParameter(request, "landid");}catch(Exception e){}
			try{fName =  ServletRequestUtils.getRequiredStringParameter(request, "First Name");}catch(Exception e){}
			try{mName =ServletRequestUtils.getRequiredStringParameter(request, "Middle Name");}catch(Exception e){}
			try{lName =ServletRequestUtils.getRequiredStringParameter(request, "Last Name");}catch(Exception e){}
			try{dob =ServletRequestUtils.getRequiredStringParameter(request, "DOB");}catch(Exception e){}
			try{relType =ServletRequestUtils.getRequiredStringParameter(request, "Relationship Type");}catch(Exception e){}

			try{gender =ServletRequestUtils.getRequiredStringParameter(request, "Gender");}catch(Exception e){}
			try{groupId =ServletRequestUtils.getRequiredStringParameter(request, "groupId");}catch(Exception e){}
