...
public class AttributeValuesHiberanteDao extends
		GenericHibernateDAO<AttributeValues, Long> implements
		AttributeValuesDao {
	private static final Logger logger = Logger.getLogger(AttributeValuesHiberanteDao.class);


	@Override
	public void addAttributeValues(List<AttributeValues> attributeValuesList,
			Long parentuid) {

		Iterator<AttributeValues> attributeValuesIter = attributeValuesList
				.iterator();
