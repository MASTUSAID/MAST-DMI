...
Cloudburst.Print = function (_map, _searchdiv) {
    ...
    jQuery.get('resources/templates/viewer/print.html', function (
        ...
        addTab($.i18n("gen-print"), template);

        $("#print-help").tipTip({
            defaultPosition: "right"
        });
        $('#map_title').html($.i18n('gen-title'));
        $('#btnPrint').attr("value", $.i18n('gen-print'));
                ...
                for (x in projects.projectLayergroups) {
                    ...
                    for (y in projects.projectLayergroups[x].layergroupBean.layerLayergroups) {
                        ...
                        if (projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.editable) {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_editablePrint").attr('title', $.i18n('layer-editable'));
                        } else {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_editablePrint").attr('title', $.i18n('layer-noneditable'));
                        }
                        ...
                        if (projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.selectable) {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_selectablePrint").attr('title', $.i18n('layer-selectable'));
                        } else {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_selectablePrint").attr('title', $.i18n('layer-nonselectable'));
                        }
                        ...
                        if (projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.queryable) {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_queryablePrint").attr('title', $.i18n('layer-queryable'));
                        } else {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_queryablePrint").attr('title', $.i18n('layer-nonqueryable'));
                        }
                        ...
                        if (projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.exportable) {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_exportablePrint").attr('title', $.i18n('layer-exportable'));
                        } else {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_exportablePrint").attr('title', $.i18n('layer-nonexportable'));
                        }
