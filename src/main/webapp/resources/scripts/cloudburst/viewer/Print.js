...
/*	
	...
	// document.write('<img src="'+img+'"/>');
	    var newWindow = window.open("", "something","scrollbars=0, toolbar=0");
		 newWindow.document.title = $("#title").val();
		newWindow.document.write('<img src="'+img+'" crossOrigin="Anonymous"/>');
*/		
	closeDialog('printdiv');	
	var element = $("#map-print"); // global variable
    ...
    onrendered: function (canvas) {
           ...
           getCanvas = canvas;*/
    	    ...
    	    $("#btnPrint").attr("download", "your_pic_name.png").attr("href", newData);
          
  		 newWindow.document.title = $("#title").val();
  		newWindow.document.write('<img src="'+newData+'" crossOrigin="Anonymous"/>');
