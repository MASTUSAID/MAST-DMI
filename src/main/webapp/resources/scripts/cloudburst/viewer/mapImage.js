	...
	var xml = new OpenLayers.Format.XML();
		...
		$.ajax({
			...
			//var layerurl_ccro = wmsurl +"bbox="+bbox+"&FORMAT=image/png&REQUEST=GetMap&layers=" + lyrs + "width=357&height=267&srs=EPSG:4326";
			 var layerurl_ccro = wmsurl +"bbox="+bbox+"&FORMAT=image/png&REQUEST=GetMap&layers=" + lyrs + "width=250&height=250&srs=EPSG:4326"+"&featureid="+layerName+"."+ID;
			//var layerurl_adj = wmsurl +"bbox="+bbox+"&FORMAT=image/png&REQUEST=GetMap&layers=" + lyrs + "width=248&height=248&srs=EPSG:4326";
			var layerurl_adj = wmsurl +"bbox="+bbox+"&FORMAT=image/png&REQUEST=GetMap&layers=" + lyrs + "width=200&height=200&srs=EPSG:4326"+"&featureid="+layerName+"."+ID;
