                        ...
                        jQuery.get("resources/templates/report/data-correctionnonnaturalperson.html", function (template)
                        {
                            ...
                            if (data != null || data != "" || data != "undefined")
                            {
                                ...
                                fetch(_url, {
                                    ...
                                    var url2 = "http://" + location.host + "/geoserver/wms?" + "bbox=" + extent + "&FORMAT=image/png&REQUEST=GetMap&layers=Mast:LBR_district,Mast:la_spatialunit_land&width=245&height=243&srs=EPSG:4326" + "&CQL_FILTER;INCLUDE;landid=" + fieldVal + ";";
